...
switch($_GET[act]){
  // Tampil Hubungi Kami
  default:
    echo "<header><h3>PESAN MASUK</h3></header>
    ...
    while ($r=mysql_fetch_array($tampil)){
      ...
      echo "<tr><td>$no</td>
                ...
                <td>$r[subjek]</td>
                <td>$tgl</a></td>
                <td><a href=?module=hubungi&act=balasemail&id=$r[id_hubungi]><img src='images/icn_baca.png' title='Baca'></a> 
		               <a href=$aksi?module=hubungi&act=hapus&id=$r[id_hubungi]><img src='images/icn_trash.png' title='Hapus'></a>
					   </td></tr>";
  ...
  case "balasemail":
    ...
    echo "<header><h3>BALAS PESAN MASUK</h3></header>
          ...
          <tr><td valign=top>Pesan</td><td> <textarea name='pesan' style='width: 600px; height: 350px;'><br><br><br><br>     
  ----------------------------------------------------------------------------------------------------------------------
