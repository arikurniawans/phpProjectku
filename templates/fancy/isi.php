...
// PRODUK DISKON
 ...
 // Apabila ada gambar dalam blog, tampilkan   
  ...
  echo " <class style=\"color:#990099;font-size:14px\"><br /><b>$k[jml]</b> 
 ...
 // Form komentar
  echo "<br/><br /><b><h6>Isi Komentar :</h6><br/>
        ...
        <form name='form' action=simpankomentar.php method=POST onSubmit='return komentar(this)'\">
  ...
  echo "<h5><a href=blog-$r[id_blog]-$r[judul_seo].html><class style=\"color:#D87A3D;\">$r[judul]</a></h5>";
