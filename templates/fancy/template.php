  ...
  <!--// SHORTCUT //-->
  <link rel="shortcut icon" href="gg_u.png" />
  ...
  <script src="<?php echo "$f[folder]/js/Dezen_Pro_Regular.js" ?>" type="text/javascript"></script>
  ...
  <link rel="stylesheet" href="<?php echo "$f[folder]/css/style2.css" ?>" type="text/css" />
  ...
  <span class="style3">&nbsp;&nbsp;I&nbsp;&nbsp;
  </span><script src="<?php echo "$f[folder]/js/selamat.js" ?>" type="text/javascript"></script>
  </b></ul></div>
  ...
  <MARQUEE direction=down height=175 onmouseout=this.start() 
